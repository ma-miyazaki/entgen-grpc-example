...
func (uu *UserUpdate) AddAdministeredIDs(ids ...string) *UserUpdate {
...
func (uu *UserUpdate) RemoveAdministeredIDs(ids ...string) *UserUpdate {
...
// AddAdministeredIDs adds the "administered" edge to the Category entity by IDs.
func (uuo *UserUpdateOne) AddAdministeredIDs(ids ...string) *UserUpdateOne {
...
// RemoveAdministeredIDs removes the "administered" edge to Category entities by IDs.
func (uuo *UserUpdateOne) RemoveAdministeredIDs(ids ...string) *UserUpdateOne {
